...
class Vector(VectorBase):
    ...
    tags = ["LISTEN_PACKAGE_ADDED_MANIFEST", "LISTEN_PACKAGE_CHANGED_MANIFEST", "LISTEN_PACKAGE_REPLACED_MANIFEST", 
            "LISTEN_PACKAGE_REMOVED_MANIFEST", "LISTEN_PACKAGE_ADDED_DYNAMIC", "LISTEN_PACKAGE_CHANGED_DYNAMIC", 
            "LISTEN_PACKAGE_REPLACED_DYNAMIC", "LISTEN_PACKAGE_REMOVED_DYNAMIC", 
            "QUERY_PERMISSION", "QUERY_OF_INTENT", "QUERY_OF_PACKAGE", "QUERY_WITHOUT_PERMISSION", "QUERY_OF_UNKNOWN_PACKAGES"] # list of tags that are checked within this class
