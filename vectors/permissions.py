...
class Vector(VectorBase):
    ...
    tags = ["USE_PERMISSION_ACCESS_MOCK_LOCATION", "PERMISSION_GROUP_EMPTY_VALUE",
            ...
            "PERMISSION_IMPLICIT_SERVICE", "DECLARED_DANGEROUS_PERMISSIONS", "CHECKED_DANGEROUS_PERMISSIONS", 
            "USED_DANGEROUS_PERMISSIONS", "UNUSED_DANGEROUS_PERMISSION", "UNCHECKED_DANGEROUS_PERMISSION", 
            "MISSING_DANGEROUS_PERMISSION"]
    ...
    def analyze(self) -> None:
        ...
        if all_permissions:
            ...
            if num_checks < num_perms and used_dangerous_permissions:
                ...
                for permission in dangerous_permissions:
                    if permission not in checked_permissions and permission in used_dangerous_permissions:
                        try:
